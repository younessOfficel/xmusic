...
* [#10131](http://dev.ckeditor.com/ticket/10131): Fixed: [`undoManager.update_tbl()`](http://docs.ckeditor.com/#!/api/CKEDITOR.plugins.undo.UndoManager-method-update) does not refresh the command state.
